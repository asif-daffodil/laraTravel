                                        ...
                                        <div class="col-lg-12">
                                            <div class="input-box">
                                                <div class="custom-checkbox mb-0">
                                                    ...
                                                    <label for="receiveChb">I want to receive TravelVela's promotional
                                                        offers
                                                        in the future</label>
                                                </div>
                                            </div>
                            ...
                            <div class="card-item shadow-none radius-none mb-0">
                                ...
                                <div class="card-body p-0">
                                    <div class="d-flex justify-content-between">
                                        <div>
                                            <h3 class="card-title">Golden Gate Seaplane Tour</h3>
                                            <p class="card-meta">124 E Huron St, New york</p>
                                        </div>
                                        <div>
                                            <a href="tour-details.html" class="btn ms-1"><i class="la la-edit"
                                    ...
                                    <ul class="list-items list-items-2 list-items-flush py-2">
                                        <li class="font-size-15">
                                            <span class="w-auto d-block mb-n1"><i
                                                    class="la la-calendar me-1 text-black font-size-17"></i>Check
                                                in</span>12 May 2020 7:40am
                                        </li>
                                        <li class="font-size-15">
                                            <span class="w-auto d-block mb-n1"><i
                                                    class="la la-calendar me-1 text-black font-size-17"></i>Check
                                                out</span>15 May 2020 7:40am
                                        </li>
                                        <li class="font-size-15">
                                            <span class="w-auto d-block mb-n1"><i
                                                    class="la la-clock-o me-1 text-black font-size-17"></i>Duration</span>3
                                            days 3 hours
                                        </li>
                                        <li class="font-size-15">
                                            <span class="w-auto d-block mb-n1"><i
                                                    class="la la-map-marker me-1 text-black font-size-17"></i>Location</span>124
                                            E Huron St, New york
                                        </li>
                                    </ul>
                                    ...
                                    <ul class="list-items list-items-2 py-3">
                                        <li><span>Tour:</span>3 Days</li>
                                        <li><span>Extra Benefits:</span>No</li>
                                        <li><span>Travellers:</span>4</li>
                                    </ul>
                                    <div class="section-block"></div>
