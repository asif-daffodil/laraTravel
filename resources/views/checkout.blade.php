                            ...
                            <div class="card-item shadow-none radius-none mb-0">
                                ...
                                <div class="card-body p-0">
                                    <div class="d-flex justify-content-between">
                                        ...
                                        <div>
                                            <a href="room-details.html" class="btn ms-1"><i class="la la-edit"
                                    ...
                                    <ul class="list-items list-items-2 list-items-flush py-2">
                                        <li class="font-size-15">
                                            <span class="w-auto d-block mb-n1"><i
                                                    class="la la-calendar me-1 font-size-17"></i>From</span>12 May 2020
                                            7:40am
                                        </li>
                                        <li class="font-size-15">
                                            <span class="w-auto d-block mb-n1"><i
                                                    class="la la-calendar me-1 font-size-17"></i>To</span>16 May 2020
                                            8:40am
                                        </li>
                                    </ul>
