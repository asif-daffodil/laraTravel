                        ...
                        <div class="form-box dashboard-card">
                            <div class="form-title-wrap">
                                <div class="d-flex justify-content-between align-items-center">
                                    ...
                                    <button type="button" class="icon-element mark-as-read-btn ms-auto me-0"
                                        data-bs-toggle="tooltip" data-placement="left" title="Mark all as read">
                                    ...
                                    <a href="#" class="list-group-item list-group-item-action border-top-0">
                                        <div class="msg-body d-flex align-items-center">
                                            ...
                                            <span class="icon-element mark-as-read-btn flex-shrink-0 ms-auto me-0"
                                                data-bs-toggle="tooltip" data-placement="left" title="Mark as read">
                                                <i class="la la-check-square"></i>
                                            </span>
                                        </div>
                                        <!-- end msg-body -->
                    ...
                    <div class="col-lg-6 responsive-column--m">
                        <div class="form-box dashboard-card">
                            ...
                            <div class="form-content">
                                ...
                                <div class="alert alert-success alert-dismissible fade show" role="alert">
                                    <i class="la la-check me-2"></i>your payment is pending
                                    for <a href="#" class="alert-link">Manali</a> Trip tour!
                                    <button type="button" class="btn-close close" data-bs-dismiss="alert"
                                        aria-label="Close"></button>
                                </div>
                                <div class="alert alert-success alert-dismissible fade show" role="alert">
                                    <i class="la la-check me-2"></i>Someone reply on your
                                    comment on
                                            ...
                                            <div class="msg-content">
                                                ...
                                                <ul class="list-items d-flex align-items-center">
                                                    <li class="font-size-14 me-2">
                                                        <span
                                                            class="badge text-bg-success py-1 px-2 font-size-13 font-weight-medium">Paid</span>
                                                    </li>
                                        ...
                                        <div class="msg-body d-flex align-items-center justify-content-between">
                                            <div class="msg-content">
                                                ...
                                                <ul class="list-items d-flex align-items-center">
                                                    <li class="font-size-14 me-2">
                                                        <span
                                                            class="badge text-bg-danger py-1 px-2 font-size-13 font-weight-medium">UnPaid</span>
                                                    </li>
                                                    <li class="font-size-14 me-2">Order: #232</li>
                                                    <li class="font-size-14">Date: 11/05/2019</li>
                                                </ul>
