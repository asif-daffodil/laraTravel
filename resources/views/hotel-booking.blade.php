                                            ...
                                            <div class="input-box">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input class="form-control" type="text" name="text"
                                                        placeholder="First name" value="Md Fahim" />
                                                </div>
                                            </div>
                                        </div>
                                        <!-- end col-lg-6 -->
                                        <div class="col-lg-6 responsive-column">
                                            <div class="input-box">
                                                ...
                                                <div class="form-group">
                                                    <span class="la la-user form-icon"></span>
                                                    <input class="form-control" type="text" name="text"
                                                        placeholder="Last name" value="Hossain" />
                                                </div>
                                            </div>
                                        </div>
                                        <!-- end col-lg-6 -->
                                            ...
                                            <div class="input-box">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input class="form-control" type="email" name="email"
                                                        placeholder="Email address" value="alifhossain174@gmail.com" />
                                                </div>
                                            </div>
                                        </div>
                                        <!-- end col-lg-6 -->
                                        <div class="col-lg-6 responsive-column">
                                            <div class="input-box">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input class="form-control" type="text" name="text"
                                                        placeholder="Phone Number" value="01969005035" />
                                                </div>
                                            </div>
                                        </div>
                                        <!-- end col-lg-6 -->
                                        <div class="col-lg-12">
                                            <div class="input-box">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input class="form-control" type="text" name="text"
                                                        placeholder="Address line" value="Gulshan" />
                                                </div>
                                            </div>
                                        </div>
                                        <!-- end col-lg-12 -->
                                        ...
                                        <div class="col-lg-12">
                                            <div class="input-box">
                                                <div class="custom-checkbox mb-0">
                                                    <input type="checkbox" class="form-check-input" id="receiveChb" />
                                                    <label for="receiveChb">I want to receive TravelVela promotional offers
                                                        in the future</label>
                                                </div>
                                            </div>
                                        </div>
                        ...
                        <div class="form-content">
                            <div class="section-tab check-mark-tab text-center pb-4">
                                <ul class="nav nav-tabs justify-content-center" id="myTab" role="tablist">
                                    <li class="nav-item">
                                        <a class="nav-link" id="credit-card-tab" data-bs-toggle="tab"
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link active" id="nagad-tab" data-bs-toggle="tab" href="#nagad"
                                            role="tab" aria-controls="nagad" aria-selected="true">
                                            <i class="la la-check icon-element"></i>
                                            <img src="images/nagad.png" alt="" />
                                            <span class="d-block pt-2">Payment with Nagad</span>
                                        </a>
                                    </li>
                                </ul>
                            </div>
                            ...
                            <div class="tab-content">
                                ...
                                <!-- end tab-pane-->
                                <div class="tab-pane fade show active" id="nagad" role="tabpanel"
                ...
                <div class="col-lg-4">
                    <div class="form-box booking-detail-form">
                        <div class="form-title-wrap">
                            ...
                            <p class="booking-number">Booking No: #1747998547</p>
                        </div>
                        <!-- end form-title-wrap -->
                        <div class="form-content">
                                ...
                                <div class="card-body p-0">
                                    <div class="d-flex justify-content-between">
                                        <div>
                                            ...
                                            <p class="card-meta">
                                                Plot: 42, Road: 03, Nasirabad Properties, South
                                                Khulshi, 4225 Chittagong
                                            </p>
                                            <p class="card-meta">Dhaka, Bangladesh</p>
                                            <p class="card-meta">Phone: +8809638-230230</p>
                                            <p class="card-meta">Email: support@travelvela.com</p>
                                        </div>
                                        <div>
                                            <a href="hotel-single.html" class="btn ms-1"><i class="la la-edit"
                                                    data-bs-toggle="tooltip" data-placement="top" title="Edit"></i></a>
                                        </div>
                                    </div>
                                    ...
                                    <ul class="list-items list-items-2 py-3">
                                        <li>
                                            <span>Traveller 1:</span>Mr testuser sdfsd (Adult)
                                        </li>
                                        <li>
                                            <span>Traveller 2:</span>Master testtwo sdfsd (Child)
                                        </li>
                                    </ul>
                                    <div class="section-block"></div>
                                    <ul class="list-items list-items-2 py-3">
